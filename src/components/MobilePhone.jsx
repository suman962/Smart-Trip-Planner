const MobilePhone = () => {
  return (
    <div class="relative mx-auto border-gray-800 dark:border-gray-800 bg-gray-800 border-[6px] 
      rounded-[1.2rem] 
      h-[315px] w-[158px] 
      md:h-[385px] md:w-[193px] md:border-[8px] md:rounded-[1.6rem]
      lg:h-[450px] lg:w-[225px] lg:border-[10px] lg:rounded-[1.8rem]">

    <div class="absolute bg-gray-800 dark:bg-gray-800 rounded-s-lg 
    ...
    <div class="absolute bg-gray-800 dark:bg-gray-800 rounded-e-lg 
    ...
    <div class="rounded-[1rem] overflow-hidden 
      ...
      <img src="./preview_mobile.png" 
          class="dark:hidden w-full h-full" alt="" />
      <img src="./preview_mobile.png" 
          class="hidden dark:block w-full h-full" alt="" />
    </div>
  </div>
  )
}
